...
public class DistilleryController {
    ...
    @GetMapping
    List<Distillery> getAllDistilleries(){
    ...
    public List<Distillery> findDistilleryWithWhiskyOfAge(@PathVariable int age){
        return distilleryRepository.haveWhiskyOfAge(age);
    }
